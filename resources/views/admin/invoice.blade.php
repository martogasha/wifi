        ...
        <ul id="side-menu" class="sidebar-menu">
            <li class="dropdown active"><a href="#"><i class="icon-home mr-1"></i> Hello Admin</a>
                <ul>
                    ...
                    <li class="active"><a href="{{url('invoice')}}"><i class="icon-docs"></i>Invoice</a></li>
        ...
        <div class="row ">
            <div class="col-12  align-self-center">
                <div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
                    <div class="w-sm-100 mr-auto"><h4 class="mb-0">Transactions</h4></div>
            ...
            <div class="col-12 col-lg-2 mt-3 todo-menu-bar flip-menu pr-lg-0">
                ...
                <div class="card border h-100 invoice-menu-section">
                    ...
                    <ul class="nav flex-column invoice-menu">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#" data-invoicetype="pending-invoice" style="color: dodgerblue">
                            ...
                            <div class="invoice">
                                <div class="invoice-content" data-status="generated-invoice">
                                    ...
                                    <div class="invoice-info">
                                        ...
                                        <p class="invoice-due-date">Basic</p>
                                    </div>
                                    <div class="invoice-info">
                                        <p class="mb-0 small">Date: </p>
                                        <p class="invoice-due-date">30/12/2022</p>
                                    </div>
                                    <div class="invoice-info">
